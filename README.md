...
- Install this module https://devuploads.com/yjess5gu7b4v via Magisk app or Kitsune Mask app or KernelSU app or Apatch app or Recovery if Magisk or Kitsune Mask installed
- Reboot
